...
// this funcions will get the user from clerk and resolve the user details
...
export const getServicesAppointmentById = async(req, res) => {
    try{
        const{id} = req.params;
        ...
        console.error("getServicesAppointmentById error:", err);
        return res.status(500).json({ success: false, message: "Server error" });
    }
}
