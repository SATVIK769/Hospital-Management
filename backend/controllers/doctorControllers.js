...
// Helper function
// this function will convert time 12hrs to number of minutes since midnight and return AM : PM.
...
// tis function will remove duplicate slot and return the slot filter by time
  ...
  try{
    ...
    if(existing.imagePublicId){
      try{
        ...
        console.warn("Deleted From Cloudinary warning: ", e?.message || e);
      }
    }
