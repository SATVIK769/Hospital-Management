...
// to get time in wither am or pm
...
// to get these detail come from server side
...
//  also check whether appt is cancel or completed then we can not change
//  it also prevent previous dates
