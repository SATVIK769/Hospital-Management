...
export const doctorListStyles = {
  ...
  doctorDetails: "text-sm text-gray-600 mt-1",
 ...
 toggleButton: (isOpen) =>
  `p-2 rounded-full bg-white border border-gray-200 shadow-sm 
   ...
   ${isOpen ? "rotate-180 text-emerald-600" : "text-gray-600"}
  `,
  ...
  statsValue: "flex items-center gap-1 text-sm font-medium",
